...
def crear_interfaz_actuadores(root):
    ...
    ruta_img_apagar = r"C:\Users\crist\Escritorio\PI-Mancillas\src\ui\views\test_images\pngegg (1).png"
    ruta_img_encender = r"C:\Users\crist\Escritorio\PI-Mancillas\src\ui\views\test_images\pngwing.com (2).png"

    img_planta_izq = ImageTk.PhotoImage(Image.open(
        r"C:\Users\crist\Escritorio\PI-Mancillas\src\ui\views\test_images\pngegg.png"
    ).resize((40, 40)))

    img_planta_der = ImageTk.PhotoImage(Image.open(
        r"C:\Users\crist\Escritorio\PI-Mancillas\src\ui\views\test_images\pngegg.png"
    ).resize((40, 40)))

    img_apagar = ImageTk.PhotoImage(Image.open(ruta_img_apagar).resize((40, 40)))
    img_encender = ImageTk.PhotoImage(Image.open(ruta_img_encender).resize((40, 40)))

     # Cargar imágenes
    bomba_on_img = ctk.CTkImage(light_image=Image.open(r"C:\Users\crist\Escritorio\PI-Ricardo\src\ui\views\test_images\bomba_off.png"),
                                dark_image=Image.open(r"C:\Users\crist\Escritorio\PI-Ricardo\src\ui\views\test_images\bomba_off.png"),
                                size=(100, 100))
    bomba_off_img = ctk.CTkImage(light_image=Image.open(r"C:\Users\crist\Escritorio\PI-Ricardo\src\ui\views\test_images\bomba_on.png"),
                                 dark_image=Image.open(r"C:\Users\crist\Escritorio\PI-Ricardo\src\ui\views\test_images\bomba_on.png"),
                                 size=(100, 100))
    ...
    def actualizar_visual(indice):
        ...
        boton_imagen = img_apagar if estado == "Inactivo" else img_encender
    ...
    header_frame.grid_columnconfigure(0, weight=1)
        # Frame que contiene las 3 partes: imagen - texto - imagen
    titulo_frame = ctk.CTkFrame(header_frame, fg_color="transparent")
    titulo_frame.grid(row=0, column=0, padx=10, pady=10)

    # Imagen izquierda (🌱)
    img_izq_label = ctk.CTkLabel(titulo_frame, image=img_planta_izq, text="")
    img_izq_label.grid(row=0, column=0, padx=5)
    ...
    # Imagen derecha (🌿)
    img_der_label = ctk.CTkLabel(titulo_frame, image=img_planta_der, text="")
    img_der_label.grid(row=0, column=2, padx=5)
    ...
    btn_ayuda.pack(side="left", padx=5, pady=2)  # <-- Corregido aquí
    ...
    btn_notificaciones.pack(side="left", padx=5, pady=2)  # <-- Alineado también
    ...
    posiciones = [
    (0.33, 0.35),  # Bomba 1 (fila 1, col 1)
    (0.67, 0.35),  # Bomba 2 (fila 1, col 2)
    (0.33, 0.8),   # Bomba 3 (fila 2, col 1)
    (0.67, 0.8)    # Bomba 4 (fila 2, col 2)
]
