...
def actualizar_grafica(frame):
    ...
    ax.plot(df['fecha_hora'], df['valor'], label="pH", color='blue', linewidth=2)
    
    ax.set_title('📊 Nivel de pH', fontsize=16, fontweight='bold')
    ax.set_xlabel('Fecha y Hora', fontsize=14)
    ax.set_ylabel('Valor de pH', fontsize=14)
