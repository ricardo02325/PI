...
def crear_interfaz_actuadores(root):
    ...
    # Cargar imágenes
    bomba_on_img = ctk.CTkImage(light_image=Image.open(r"C:\Users\crist\Escritorio\PI\src\ui\views\test_images\bomba_on.png"),
                                dark_image=Image.open(r"C:\Users\crist\Escritorio\PI\src\ui\views\test_images\bomba_on.png"),
                                size=(100, 100))  # Ajusta el tamaño de la imagen según sea necesario
    bomba_off_img = ctk.CTkImage(light_image=Image.open(r"C:\Users\crist\Escritorio\PI\src\ui\views\test_images\bomba_off.png"),
                                 dark_image=Image.open(r"C:\Users\crist\Escritorio\PI\src\ui\views\test_images\bomba_off.png"),
